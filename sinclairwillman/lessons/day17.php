...
$message = Swift_Message::newInstance('Software Development Test')
  ->setFrom(array('sinclairwillman@seattleacademy.org' => 'Sinclair Willman Test'))
  ->setTo(array('ganderson@seattleacademy.org','sinclairwillman@seattleacademy.org','saasmath@hotmail.com',$_REQUEST{'user_email'}))
