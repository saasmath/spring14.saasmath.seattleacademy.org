...
$message = Swift_Message::newInstance('Software Devolopment Test')
  ->setFrom(array('julietromano@seattleacademy.org' => 'Juliet Romano'))
  ->setTo(array('ganderson@seattleacademy.org','julietromano@seattleacademy.org','saasmath@gmail.com',$_REQUEST['user_email']))
