...
var mycounter = setInterval(timer, 1000); //1000 will  run it every 1 second
...
$(document).ready(function() {
    ...
    $('#togglebuttons').click(function() {
        $('.buttonchoice').toggle();
        $('#answerform').toggle();
        msg1="Hard Mode (2 points";
        if ($("#togglebuttons").html()==msg1){
             $("#togglebuttons").html("Easy Mode (1 point)");
        }
        else{
        $("#togglebuttons").html(msg1);
    }
