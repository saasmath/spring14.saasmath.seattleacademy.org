window.onload = function() {
	var canvas = document.getElementById("stage"),
		...
		sun1 = ball.create(300, 200, 0, 0),
		sun2 = ball.create(800, 600, 0, 0),
		emitter = {
			x: 100,
			y: 0
		},
	...
	for(var i = 0; i < numParticles; i += 1) {
		var p = ball.create(emitter.x, emitter.y, utils.randomRange(7, 8), Math.PI / 2 + utils.randomRange(-0.1, 0.1));
